...
gallery.addEventListener("click", e => {
    ...
    const linkToImage = e.target.dataset.source;
    const descriptionToImage = e.target.getAttribute("alt");

    basicLightbox.create(`<img src="${linkToImage}" alt="${descriptionToImage}" width="1112" height="640">`).show();
});
